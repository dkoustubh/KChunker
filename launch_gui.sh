#!/bin/bash
# KChunker Dashboard Launcher for Ubuntu/Linux
# Double-clicking this file or executing it opens Terminal, prompts for a file path, and launches the dashboard.
...
# Clean up terminal drag-and-drop artifacts (stripping surrounding quotes and escaping backslashes)
